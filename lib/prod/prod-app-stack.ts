...
export class ProdAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const energyAppLogs = new aws_logs.LogGroup(this, "ProdLogGroup", {
      logGroupName: `/aws/lambda/ohme-prod-${energyAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });

    const energyAppDb = new aws_dynamodb.Table(this, "ProdDynamoDB", {
      tableName: `ohme-prod-${energyAppConfig.appName}`,
    ...
    const energyAppRole = new aws_iam.Role(this, "ProdLambdaRole", {
    ...
    const energyAppLambda = new aws_lambda.DockerImageFunction(this, "", {
      functionName: "ohme-prod-" + energyAppConfig.appName,
    ...
    const customerAppLogs = new aws_logs.LogGroup(this, "ProdLogGroup", {
      logGroupName: `/aws/lambda/ohme-prod-${customerAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });

    const customerAppDb = new aws_dynamodb.Table(this, "ProdDynamoDB", {
      tableName: `ohme-prod-${customerAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const customerAppRole = new aws_iam.Role(this, "ProdLambdaRole", {
    ...
    const customerAppLambda = new aws_lambda.DockerImageFunction(this, "ProdLambda", {
      functionName: "ohme-prod-" + customerAppConfig.appName,
    ...
    const pricingAppLogs = new aws_logs.LogGroup(this, "ProdLogGroup", {
      logGroupName: `/aws/lambda/ohme-prod-${pricingAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });

    const pricingAppDb = new aws_dynamodb.Table(this, "ProdDynamoDB", {
      tableName: `ohme-prod-${pricingAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const pricingAppRole = new aws_iam.Role(this, "ProdLambdaRole", {
    ...
    const pricingAppLambda = new aws_lambda.DockerImageFunction(this, "ProdLambda", {
      functionName: "ohme-prod-" + pricingAppConfig.appName,
    ...
    const orderAppLogs = new aws_logs.LogGroup(this, "ProdLogGroup", {
      logGroupName: `/aws/lambda/ohme-prod-${orderAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });

    const orderAppDb = new aws_dynamodb.Table(this, "ProdDynamoDB", {
      tableName: `ohme-prod-${orderAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const orderAppRole = new aws_iam.Role(this, "ProdLambdaRole", {
    ...
    const orderAppLambda = new aws_lambda.DockerImageFunction(this, "ProdLambda", {
      functionName: "ohme-prod-" + orderAppConfig.appName,
