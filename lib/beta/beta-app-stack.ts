...
export class BetaAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const energyAppLogs = new aws_logs.LogGroup(this, "BetaLogGroup", {
      logGroupName: `/aws/lambda/ohme-beta-${energyAppConfig.appName}`,
    ...
    const energyAppDb = new aws_dynamodb.Table(this, "", {
      tableName: `ohme-beta-${energyAppConfig.appName}`,
    ...
    const energyAppLambda = new aws_lambda.DockerImageFunction(this, "", {
      functionName: "ohme-beta-" + energyAppConfig.appName,
    ...
    const customerAppLogs = new aws_logs.LogGroup(this, "", {
      logGroupName: `/aws/lambda/ohme-beta-${customerAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });
    ...
    const customerAppDb = new aws_dynamodb.Table(this, "", {
      tableName: `ohme-beta-${customerAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const customerAppLambda = new aws_lambda.DockerImageFunction(this, "", {
      functionName: "ohme-beta-" + customerAppConfig.appName,
    ...
    const pricingAppLogs = new aws_logs.LogGroup(this, "", {
      logGroupName: `/aws/lambda/ohme-beta-${pricingAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });
    ...
    const pricingAppDb = new aws_dynamodb.Table(this, "", {
      tableName: `ohme-beta-${pricingAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const pricingAppLambda = new aws_lambda.DockerImageFunction(this, "", {
      functionName: "ohme-beta-" + pricingAppConfig.appName,
    ...
    const orderAppLogs = new aws_logs.LogGroup(this, "", {
      logGroupName: `/aws/lambda/ohme-beta-${orderAppConfig.appName}`,
      logGroupClass: aws_logs.LogGroupClass.STANDARD,
      retention: aws_logs.RetentionDays.THREE_DAYS,
      removalPolicy: cdk.RemovalPolicy.DESTROY
    });
    ...
    const orderAppDb = new aws_dynamodb.Table(this, "", {
      tableName: `ohme-beta-${orderAppConfig.appName}`,
      tableClass: aws_dynamodb.TableClass.STANDARD,
    ...
    const orderAppLambda = new aws_lambda.DockerImageFunction(this, "", {
      functionName: "ohme-beta-" + orderAppConfig.appName,
